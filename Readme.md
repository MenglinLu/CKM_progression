...
1. Install the pySuStaIn package referring to https://github.com/ucl-pond/pySuStaIn
2. Run `python sustain/sustain.py` to conduct subtype and stage inference
