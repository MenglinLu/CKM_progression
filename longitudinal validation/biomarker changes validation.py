...
data_baseline = data_val[biomarkers_baseline]

###-----Biomarker statistics of patients remained in Phase 1 at follow-up-----
data_ins1_inphase1 = data_val.loc[data_val['phase_ins1']==1,biomarkers]

###-----Biomarker statistics of patients progressed to Phase 2 at follow-up-----
data_ins1_inphase2 = data_val.loc[data_val['phase_ins1']==2,biomarkers]

###-----Biomarker statistics of patients progressed to Phase 3 at follow-up-----
data_ins1_inphase3 = data_val.loc[data_val['phase_ins1']==3,biomarkers]
