...
data_all$ml_stage <- data_all$ml_stage-2
...
for(subtype_i in c(0,1,2,3)){
  ...
  for(task in c('hf','af','chd','stroke',
                'stroke_haemorr','stroke_infarc','atherosclerosis','death')){
...
write.csv(result_df,'E:/CKM1/GMM_mets_K4/HR_stage_reference_control_covariate-3stage.csv')